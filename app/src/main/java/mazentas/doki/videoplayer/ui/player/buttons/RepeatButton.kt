...
private fun repeatModeIconPainter(repeatMode: @Player.RepeatMode Int): Painter {
    return when (repeatMode) {
        Player.REPEAT_MODE_OFF -> painterResource(R.drawable.ic_loop_off)
        Player.REPEAT_MODE_ONE -> painterResource(R.drawable.ic_loop_one)
        else -> painterResource(R.drawable.ic_loop_all)
    }
}
