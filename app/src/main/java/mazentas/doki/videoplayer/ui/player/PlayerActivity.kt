...
import mazentas.doki.videoplayer.ui.player.extensions.registerForSuspendActivityResult
...
import mazentas.doki.videoplayer.ui.player.service.PlayerService
import mazentas.doki.videoplayer.ui.player.service.addSubtitleTrack
import mazentas.doki.videoplayer.ui.player.service.stopPlayerSession
...
import mazentas.doki.videoplayer.common.extensions.getMediaContentUri
        ...
        setContent {
            ...
            DokiPlayerTheme(darkTheme = true) {
                ...
                MediaPlayerScreen(
                    ...
                    viewModel = viewModel,
                    playerPreferences = uiState.playerPreferences ?: return@DokiPlayerTheme,
